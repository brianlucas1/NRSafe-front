...
import { ItemNormaComponent } from "./pages/item-norma/item-norma.component";
...
export const PLANO_ACAO_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'visitas/:idPlanoAcao/normas/:idPlanoAcaoNorma/itens', component: ItemNormaComponent } // Tela 3
